...
This page documents the current BoredOS userland libc surface from `usr/libc/include/`.
...
- libc high-level I/O and process APIs are backed by wrappers in `usr/libc/src/syscall.c`.
